...
<main class="flex flex-col p-5 overflow-y-scroll w-full h-full gap-4">
    ...
    <div class="flex flex-row w-full gap-4">
        <div class="flex justify-center items-center secondary-bg rounded-2xl w-full h-[512px] p-8">
    ...
    <div class="flex flex-row w-full gap-4">
        <div class="flex flex-col justify-center items-center secondary-bg rounded-2xl w-1/2 p-8">
    ...
    <div class="flex flex-row w-full gap-4">
        <div class="flex justify-center items-center secondary-bg rounded-2xl w-full p-8 font-bold text-2xl">
